...
export class EmailClient {
     ...
     * @param includeContents (optional)
     */
    getAllByUser(userId, search, skip, take, statuses, includeContents, cancelToken) {
...
export class ObservationClient {
     ...
     */
    getAllForGroup(groupId, search, skip, take, definitionId, from, to, friendly, anonymousUser, cancelToken) {
     ...
     * @param friendly (optional)
     */
    getAllForPublisher(publisherId, search, skip, take, definitionId, groupId, from, to, friendly, cancelToken) {
...
export class ObservationDefinitionClient {
     ...
     */
    getAllByActivation(search, skip, take, consumerId, publisherId, programId, itemId, activated, cancelToken) {
        let url_ = this.baseUrl + "/v1/ObservationDefinition?";
        if (search !== undefined && search !== null)
            url_ += "Search=" + encodeURIComponent("" + search) + "&";
        if (skip === null)
     ...
     */
    getAllPublished(search, skip, take, publisherId, programId, countryCode, cancelToken) {
...
export class ObservationMigrationClient {
     ...
     */
    duplicateObservationDefinition(observationDefinitionId, settings, cancelToken) {
...
export class ItemActivationClient {
     ...
     */
    getAllForPublisher(publisherId, search, skip, take, itemType, programId, consumerId, includeDeactivated, cancelToken) {
     ...
     * @param publisherId (optional)
     */
    getAllByActivation(search, skip, take, consumerId, itemType, itemId, programId, publisherId, cancelToken) {
...
export class ProgramClient {
     ...
     * @param activated (optional)
     */
    getAllByActivation(search, skip, take, consumerId, publisherId, itemId, activated, cancelToken) {
...
export class SurveyResponseClient {
     ...
     */
    getAllForSurvey(surveyId, search, skip, take, groupId, publisherId, contentId, jobTypeId, submitted, cancelToken) {
     ...
     * @param submitted (optional)
     */
    getAllForRespondent(respondentId, search, skip, take, surveyId, submitted, cancelToken) {
...
export class BookAttemptClient {
     ...
     * @param to (optional)
     */
    getAllForGroup(groupId, search, skip, take, moduleId, actorType, from, to, cancelToken) {
...
export class CertificationClient {
     ...
     * @param at (optional) The UTC time at which to get certificates. If not specified, the current time is used.
     */
    getAllHistoryForGroup(groupId, skip, take, certificateId, memberStatus, role, at, cancelToken) {
...
export class ClassClient {
     ...
     */
    getAll(search, skip, take, organisationId, teamId, publisherId, courseId, programId, activated, cancelToken) {
...
export class EnrolmentClient {
    ...
    - "none" to filter to items not in any program
     */
    getAllForTrainee(traineeId, search, skip, take, activated, programId, cancelToken) {
...
export class AssessmentSubAttemptClient {
     ...
     * @param to (optional)
     */
    getAllForGroup(groupId, search, skip, take, assessmentId, actorType, from, to, cancelToken) {
...
export class MemberClient {
     ...
     * @param includeDeactivated (optional)
     */
    getAllForGroup(groupId, search, skip, take, status, jobTypeIds, jobCategories, roles, includeDeactivated, cancelToken) {
     ...
     * @param includeDeactivated (optional)
     */
    getAllForChildGroups(groupId, childGroupType, search, skip, take, status, jobTypeIds, jobCategories, memberRoles, identityPermission, includeDeactivated, cancelToken) {
...
export class UserActivityClient {
     ...
     * @param to (optional)
     */
    getAllForGroup(groupId, search, skip, take, moduleType, programId, from, to, cancelToken) {
     ...
     * @param to (optional)
     */
    getAllForPublisher(publisherId, search, skip, take, moduleType, programId, from, to, cancelToken) {
...
export class UserClient {
    ...
    welcomeEmailTemplate(userName, userEmail, creatorName, message_CreatorName, message_CreatorImageUri, message_CreatorDescription, message_Message, welcomeButtonUri, welcomeButtonText, group_Title, group_ImageUri, group_Uri, group_Description, group_Subtitle, group_SubtitleImageUri, group_ActionButton, group_ActionUri, applicationName, productName, supportUri, termOfServiceUri, cancelToken) {
    ...
    contactEmailTemplate(userName, creatorEmail, creatorName, message_CreatorName, message_CreatorImageUri, message_CreatorDescription, message_Message, group_Title, group_ImageUri, group_Uri, group_Description, group_Subtitle, group_SubtitleImageUri, group_ActionButton, group_ActionUri, cancelToken) {
...
(function (ProgramPhaseActivationStatus) {
    ProgramPhaseActivationStatus[ProgramPhaseActivationStatus["NotActivated"] = 0] = "NotActivated";
    ProgramPhaseActivationStatus[ProgramPhaseActivationStatus["Requested"] = 1] = "Requested";
    ProgramPhaseActivationStatus[ProgramPhaseActivationStatus["Activated"] = 2] = "Activated";
    ProgramPhaseActivationStatus[ProgramPhaseActivationStatus["Deactivated"] = 3] = "Deactivated";
...
(function (ProgramResourceType) {
    ...
    ProgramResourceType[ProgramResourceType["ObservationDefinition"] = 1] = "ObservationDefinition";
    ProgramResourceType[ProgramResourceType["Survey"] = 2] = "Survey";
    ProgramResourceType[ProgramResourceType["Implementation"] = 3] = "Implementation";
...
(function (IntegerQuestionDisplayType) {
    ...
    IntegerQuestionDisplayType[IntegerQuestionDisplayType["Counter"] = 1] = "Counter";
...
(function (TrainingSessionStatus) {
    ...
    TrainingSessionStatus[TrainingSessionStatus["NotStarted"] = 1] = "NotStarted";
...
(function (AuthenticationMethod) {
    ...
    AuthenticationMethod[AuthenticationMethod["OneTimePasscode"] = 1] = "OneTimePasscode";
})(AuthenticationMethod || (AuthenticationMethod = {}));
/** 0 = None 1 = Sms 2 = Email */
export var TwoFactorAuthenticationType;
(function (TwoFactorAuthenticationType) {
    TwoFactorAuthenticationType[TwoFactorAuthenticationType["None"] = 0] = "None";
    TwoFactorAuthenticationType[TwoFactorAuthenticationType["Sms"] = 1] = "Sms";
    TwoFactorAuthenticationType[TwoFactorAuthenticationType["Email"] = 2] = "Email";
